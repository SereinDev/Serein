...
| 版本&更新日志                                  | 更新日期 | 下载                                                                                                                                                                 |
| ---------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [v1.3.4](Versions/v1.3.4.md) <small>*[即将到来]*</small> | 23/2/?   | [![github](https://img.shields.io/github/downloads/Zaitonn/Serein/v1.3.4/total?style=flat-square ":no-zoom")](https://github.com/Zaitonn/Serein/releases/tag/v1.3.4) |
