...
namespace Serein.Windows.Controls
{
    public class PopupEx : Popup
    {
        ...
        private void pup_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            while (win != null && (win as System.Windows.Window) == null)
            {
                win = VisualTreeHelper.GetParent(win);
            }
            if ((win as System.Windows.Window) != null)
            {
                (win as System.Windows.Window).LocationChanged -= PositionChanged;
                (win as System.Windows.Window).SizeChanged -= PositionChanged;
                if (IsPositionUpdate)
                {
                    (win as System.Windows.Window).LocationChanged += PositionChanged;
                    (win as System.Windows.Window).SizeChanged += PositionChanged;
        ...
        //是否最前默认为非最前（false）  
        public static DependencyProperty TopmostProperty = System.Windows.Window.TopmostProperty.AddOwner(typeof(Popup), new FrameworkPropertyMetadata(false, OnTopmostChanged));
        public bool Topmost
        {
