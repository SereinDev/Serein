        ...
        public static void GetAnnouncement()
        {
            ...
            while (true)
            {
                if (Global.Ui != null && Global.Ui.Visible && Global.Settings.Serein.EnableGetAnnouncement)
                {
                    try
                    {
                        string AnnouncementId = RequestInfo("https://serein.cc/Serein/announcement/latest.txt");
                        if (OldAnnouncementId != AnnouncementId)
                        {
                            OldAnnouncementId = AnnouncementId;
                            Global.Ui.ShowBalloonTip(RequestInfo($"https://serein.cc/Serein/announcement/{AnnouncementId}.txt").Replace("\\n", "\n"));
                        }
                    }
                    catch (Exception e)
                    {
