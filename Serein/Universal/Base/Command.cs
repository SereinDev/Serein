    ...
    internal class Command
    {
            ...
            )
        {
            /*
                ...
                4   EventTrigger
            */
            Logger.Out(999, "[Command:Run()]", $"InputType:{InputType} | Command:\"{Command}\" | UserId:\"{UserId}\" | GroupId:\"{GroupId}\"");
            ...
            switch (Type)
            {
                ...
                case 40:
                    ...
                    break;
                case 50:
                    Logger.Out(999, "[DebugOutput]", Value);
                    break;
            }
        ...
        public static string GetValue(string command, Match MsgMatch = null)
        {
            ...
            Logger.Out(999, "[Command:GetValue()]", $"Value:{Value}");
            return Value;
        }
        ...
        public static string ApplyVariables(string Text, JObject JsonObject = null, bool DisableMotd = false)
        {
            ...
            if (JsonObject != null)
            {
                ...
                {
                    Logger.Out(999, "[Command:GetVariables()]", e.ToString());
                }
            }
