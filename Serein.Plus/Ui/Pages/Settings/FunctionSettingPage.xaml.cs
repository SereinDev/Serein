...
public partial class FunctionSettingPage : Page
{
    private readonly IHost _host;

    private IServiceProvider Services => _host.Services;
    private SettingProvider SettingProvider => Services.GetRequiredService<SettingProvider>();
    private FunctionSetting FunctionSetting => SettingProvider.Value.Function;

    public FunctionSettingPage(IHost host)
    {
        _host = host;
        InitializeComponent();
